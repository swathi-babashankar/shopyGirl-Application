...
const {createAdmin, getAdminAccount, editAdmin, adminLogin, adminLogout, deleteAccount} = require("../controllers/adminController");
...
router.get("/getAdminAccount/:adminId?",adminAuth, getAdminAccount);
